package net.shadowbeast.arcanemysteries.client.ClientHandler;
...
import net.shadowbeast.arcanemysteries.items.ItemStrongholdCompass;
...
public class ClientHandler {
    ...
    public static void ClientHandling(final FMLClientSetupEvent event) {
            ItemProperties.register(ItemRegistry.STRONGHOLD_COMPASS.get(), new ResourceLocation("angle"), new ItemPropertyFunction() {
                @OnlyIn(Dist.CLIENT)
